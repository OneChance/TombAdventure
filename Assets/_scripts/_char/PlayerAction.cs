...
public class PlayerAction : MonoBehaviour
{
	...
	void Start ()
	{
		...
		if (gData.characterList == null || gData.characterList.Count == 0) {
			...
			Character c = new Character (100,100, 50, 0, 0, "zhouhui", false,100,100,ProFactory.getPro("Geomancer","1"));
			...
			Character c2 = new Character (100, 100,50, 0, 0, "unity", false,100,100,ProFactory.getPro("Settler","1"));
