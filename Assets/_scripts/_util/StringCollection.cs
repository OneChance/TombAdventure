...
public class StringCollection
{
	...
	public static string DISTANCECLOSE = "已经非常接近入口了";
	public static string RIGHT = "右";
	public static string LEFT = "左";
	public static string UP = "上";
	public static string DOWN = "下";
	public static string NOGEO = "队伍中没有风水师,无法进行探测";
	public static string LEADERNOSTAMINA = "队长已经没有体力了!";
	...
	public static string INVALIDACCOUNT = "无效的用户名或密码";
